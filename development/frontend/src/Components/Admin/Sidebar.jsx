...
function Sidebar() {
  ...
  const menu = [
    ...
    { name: "Noticias", path: "/administracion/noticias", icon: Newspaper, requiredPermission: "catalog.write" },
    { name: "Carrusel", path: "/administracion/carrusel", icon: Images, requiredPermission: "catalog.write" },
    ...
    { name: "Etiquetas", path: "/administracion/etiquetas", icon: Settings, requiredPermission: "admin_general.manage" },
