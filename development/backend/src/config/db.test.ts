...
describe('Database Config - Cobertura 100%', () => {
  ...
  it('debería inicializar el Pool con los parámetros de env (Líneas 4-10)', async () => {
    // Importamos el archivo dinámicamente para capturar la inicialización del pool
    await import('./db'); 

    // Ahora el mock de Pool sí tendrá registrada la llamada
