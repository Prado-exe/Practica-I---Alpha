...
exports.fetchInstitutionsFromDb = fetchInstitutionsFromDb;
exports.createInstitutionInDb = createInstitutionInDb;
exports.updateInstitutionInDb = updateInstitutionInDb;
exports.deleteInstitutionFromDb = deleteInstitutionFromDb;
exports.fetchPublicInstitutionsPaginated = fetchPublicInstitutionsPaginated;
/**
 * ============================================================================
 ...
 */
async function createInstitutionInDb(instData, fileData, accountId) {
 ...
 */
async function updateInstitutionInDb(id, instData, fileData, accountId) {
    const client = await db_1.pool.connect();
    try {
        await client.query('BEGIN');
 ...
 */
async function deleteInstitutionFromDb(id) {
    const query = `DELETE FROM institutions WHERE institution_id = $1`;
    const { rowCount } = await db_1.pool.query(query, [id]);
    return rowCount ?? 0;
}
/**
 ...
 * @throws {Ninguna}
 */
async function fetchPublicInstitutionsPaginated(search, limit, offset) {
    let baseQuery = `
    FROM institutions i
    INNER JOIN aws_file_references afr ON i.logo_file_id = afr.aws_file_reference_id
