...
exports.findRoleIdByCode = findRoleIdByCode;
...
exports.findAccountLoginByEmail = findAccountLoginByEmail;
exports.findAccountBasicByEmail = findAccountBasicByEmail;
exports.findLatestVerificationCodeByAccountId = findLatestVerificationCodeByAccountId;
...
exports.lockAccountUntil = lockAccountUntil;
exports.updateAccountStatus = updateAccountStatus;
exports.updateLastLoginAt = updateLastLoginAt;
exports.incrementVerificationAttempts = incrementVerificationAttempts;
exports.consumeVerificationCode = consumeVerificationCode;
exports.activateAccount = activateAccount;
exports.createAuthSession = createAuthSession;
exports.findAuthSessionById = findAuthSessionById;
exports.revokeAuthSession = revokeAuthSession;
exports.updateAuthSessionLastUsed = updateAuthSessionLastUsed;
exports.findAccountByIdForSession = findAccountByIdForSession;
exports.rotateAuthSessionRefreshToken = rotateAuthSessionRefreshToken;
exports.revokeAllActiveSessionsByAccountId = revokeAllActiveSessionsByAccountId;
exports.invalidateActiveVerificationCodes = invalidateActiveVerificationCodes;
exports.markVerificationCodeResent = markVerificationCodeResent;
exports.blockVerificationCodeUntil = blockVerificationCodeUntil;
exports.createPasswordResetToken = createPasswordResetToken;
exports.findValidVerificationCodeByHash = findValidVerificationCodeByHash;
exports.updateAccountPassword = updateAccountPassword;
exports.createRevalidationCode = createRevalidationCode;
...
exports.fetchAllUsersFromDb = fetchAllUsersFromDb;
exports.updateUserStatusInDb = updateUserStatusInDb;
exports.getUserRoleCodeById = getUserRoleCodeById;
exports.deleteUserFromDb = deleteUserFromDb;
exports.updateUserAdminInDb = updateUserAdminInDb;
exports.fetchActiveRolesFromDb = fetchActiveRolesFromDb;
/**
 * ============================================================================
 ...
 */
async function findRoleIdByCode(code) {
    const query = `
    SELECT role_id
    FROM roles
    WHERE code = $1
    LIMIT 1
  `;
    const { rows } = await db_1.pool.query(query, [code]);
...
async function findAccountByUsername(username) {
    ...
    LIMIT 1
  `;
    const { rows } = await db_1.pool.query(query, [username]);
    return rows[0] ?? null;
}
/**
 ...
 * @throws {Ninguna}
 */
async function findLatestVerificationCodeByAccountId(accountId, codeType) {
    const query = `
    SELECT
    ...
    LIMIT 1
  `;
    const { rows } = await db_1.pool.query(query, [accountId, codeType]);
    return rows[0] ?? null;
}
/**
 ...
 * @throws {Ninguna}
 */
async function incrementFailedLoginAttempts(accountId) {
    const query = `
    UPDATE accounts
    SET
    ...
    WHERE account_id = $1
  `;
    await db_1.pool.query(query, [accountId]);
}
/**
 ...
 * @throws {Ninguna}
 */
async function resetFailedLoginAttempts(accountId) {
    const query = `
    UPDATE accounts
    SET
 ...
 * @throws {Ninguna}
 */
async function lockAccountUntil(accountId, lockedUntil) {
    const query = `
    UPDATE accounts
    SET
      locked_until = $2,
    ...
    WHERE account_id = $1
  `;
    await db_1.pool.query(query, [accountId, lockedUntil]);
}
/**
...
async function updateAccountStatus(accountId, status) {
    ...
    WHERE account_id = $1
  `;
    await db_1.pool.query(query, [accountId, status]);
}
/**
 ...
 * @throws {Ninguna}
 */
async function updateLastLoginAt(accountId) {
    const query = `
    UPDATE accounts
    SET
      last_login_at = NOW(),
...
async function incrementVerificationAttempts(verificationCodeId) {
  ...
  `;
    await db_1.pool.query(query, [verificationCodeId]);
}
/**
 ...
 * @throws {Ninguna}
 */
async function findAuthSessionById(sessionId) {
    const query = `
    SELECT
      session_id,
      account_id,
    ...
    LIMIT 1
  `;
    const { rows } = await db_1.pool.query(query, [sessionId]);
    return rows[0] ?? null;
}
/**
...
async function revokeAuthSession(sessionId, reason = "logout") {
    ...
    WHERE session_id = $1
  `;
    await db_1.pool.query(query, [sessionId, reason]);
}
/**
 ...
 * @throws {Ninguna}
 */
async function updateAuthSessionLastUsed(sessionId) {
    const query = `
    UPDATE auth_sessions
    SET
      last_used_at = NOW(),
    ...
    WHERE session_id = $1
  `;
    await db_1.pool.query(query, [sessionId]);
}
/**
 ...
 * @throws {Ninguna}
 */
async function findAccountByIdForSession(accountId) {
    const query = `
    SELECT
      a.account_id,
      a.username,
    ...
    LIMIT 1
  `;
    const { rows } = await db_1.pool.query(query, [accountId]);
    return rows[0] ?? null;
}
/**
 ...
 * @throws {Ninguna}
 */
async function rotateAuthSessionRefreshToken(sessionId, currentRefreshTokenId, refreshTokenHash, expiresAt) {
    const query = `
    UPDATE auth_sessions
    SET
 ...
 * @throws {Ninguna}
 */
async function revokeAllActiveSessionsByAccountId(accountId, reason = "new_login") {
    const query = `
    UPDATE auth_sessions
    SET
      is_revoked = TRUE,
  ...
  `;
    await db_1.pool.query(query, [accountId, reason]);
}
/**
 ...
 * @throws {Ninguna}
 */
async function invalidateActiveVerificationCodes(accountId, codeType, reason) {
    const query = `
    UPDATE verification_codes
    SET
      invalidated_at = NOW(),
  ...
  `;
    await db_1.pool.query(query, [accountId, codeType, reason]);
}
/**
 ...
 * @throws {Ninguna}
 */
async function markVerificationCodeResent(verificationCodeId, expiresAt, codeHash) {
    const query = `
    UPDATE verification_codes
    SET
      code_hash = $2,
    ...
    WHERE verification_code_id = $1
  `;
    await db_1.pool.query(query, [verificationCodeId, codeHash, expiresAt]);
}
/**
 ...
 * @throws {Ninguna}
 */
async function blockVerificationCodeUntil(verificationCodeId, blockedUntil) {
    const query = `
    UPDATE verification_codes
    SET blocked_until = $2
    WHERE verification_code_id = $1
  `;
    await db_1.pool.query(query, [verificationCodeId, blockedUntil]);
}
/**
...
async function createPasswordResetToken(accountId, tokenHash, expiresAt) {
  ...
  `;
    await db_1.pool.query(query, [accountId, tokenHash, expiresAt]);
}
/**
 ...
 * @throws {Ninguna}
 */
async function findValidVerificationCodeByHash(codeHash, codeType) {
    const query = `
    ...
    LIMIT 1
  `;
    const { rows } = await db_1.pool.query(query, [codeHash, codeType]);
    return rows[0] ?? null;
}
/**
...
async function updateAccountPassword(accountId, newPasswordHash) {
    ...
    WHERE account_id = $1
  `;
    await db_1.pool.query(query, [accountId, newPasswordHash]);
}
/**
 ...
 * @throws {Ninguna}
 */
async function createRevalidationCode(accountId, email, codeHash, expiresAt) {
    const query = `
    INSERT INTO verification_codes (
      account_id, 
      code_type, 
  ...
  `;
    await db_1.pool.query(query, [accountId, email, codeHash, expiresAt]);
}
/**
...
async function findValidPasswordResetToken(tokenHash) {
    ...
    LIMIT 1
  `;
    const { rows } = await db_1.pool.query(query, [tokenHash]);
    return rows[0] ?? null;
}
/**
...
async function consumePasswordResetToken(tokenId) {
  ...
  `;
    await db_1.pool.query(query, [tokenId]);
}
/**
 ...
 * @throws {Ninguna}
 */
async function updateUserStatusInDb(userId, newStatus) {
    const query = `
    UPDATE accounts 
  ...
  `;
    const { rowCount } = await db_1.pool.query(query, [newStatus, userId]);
 ...
 * @throws {Ninguna}
 */
async function getUserRoleCodeById(userId) {
    const query = `
    SELECT r.code 
    FROM accounts a 
    JOIN roles r ON a.role_id = r.role_id 
...
async function deleteUserFromDb(userId) {
    ...
    const { rowCount } = await db_1.pool.query(query, [userId]);
    return rowCount ?? 0;
}
/**
 ...
 * @throws {Ninguna}
 */
async function updateUserAdminInDb(id, fullName, email, roleId, passwordHash) {
    if (passwordHash) {
        ...
        const { rowCount } = await db_1.pool.query(query, [fullName, email, roleId, passwordHash, id]);
        return rowCount ?? 0;
    }
    else {
        const query = `UPDATE accounts SET full_name = $1, email = $2, role_id = $3, updated_at = NOW() WHERE account_id = $4 RETURNING account_id`;
        const { rowCount } = await db_1.pool.query(query, [fullName, email, roleId, id]);
        return rowCount ?? 0;
    }
}
/**
 ...
 * @throws {Ninguna}
 */
async function fetchActiveRolesFromDb() {
    const query = `
    SELECT code, name 
    FROM roles 
