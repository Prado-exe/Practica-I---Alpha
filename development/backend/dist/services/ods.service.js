...
exports.getOdsForDropdown = getOdsForDropdown;
/**
 * ============================================================================
 ...
 * ============================================================================
 */
const ods_repository_1 = require("../repositories/ods.repository");
/**
 ...
 */
async function getOdsForDropdown() {
    return await (0, ods_repository_1.fetchAllOdsFromDb)();
}
