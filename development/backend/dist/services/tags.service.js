...
exports.getTagsForDropdown = getTagsForDropdown;
/**
 * ============================================================================
 ...
 * ============================================================================
 */
const tags_repository_1 = require("../repositories/tags.repository");
/**
 ...
 */
async function getTagsForDropdown() {
    return await (0, tags_repository_1.fetchAllTagsFromDb)();
}
