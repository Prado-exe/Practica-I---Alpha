...
exports.generateUploadUrlAction = generateUploadUrlAction;
/**
 * ============================================================================
 ...
 */
async function generateUploadUrlAction(req, res) {
    try {
        const body = await (0, body_1.readJsonBody)(req);
        if (!body.fileName || !body.contentType) {
            return (0, json_1.sendJson)(res, 400, { ok: false, message: "El nombre (fileName) y tipo (contentType) del archivo son requeridos" });
        }
        ...
        const fileUrl = `${env_1.env.S3_ENDPOINT}/${env_1.env.S3_BUCKET_NAME}/${uniqueKey}`;
