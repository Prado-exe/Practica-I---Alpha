...
exports.getDatasetsAction = getDatasetsAction;
exports.createDatasetAction = createDatasetAction;
exports.getDatasetByIdAction = getDatasetByIdAction;
exports.deleteDatasetAction = deleteDatasetAction;
exports.updateDatasetAction = updateDatasetAction;
exports.getPublicDatasetsAction = getPublicDatasetsAction;
exports.getPublicDatasetByIdAction = getPublicDatasetByIdAction;
exports.requestDatasetAction = requestDatasetAction;
exports.validateDatasetAction = validateDatasetAction;
/**
 * ============================================================================
 ...
 * ============================================================================
 */
const datasets_service_1 = require("../services/datasets.service");
 ...
 */
async function getDatasetsAction(req, res) {
    try {
        ...
        const result = await (0, datasets_service_1.getDatasets)(accountId, isAdmin, search, page, limit, {});
        (0, json_1.sendJson)(res, 200, { ok: true, ...result });
    }
    catch (error) {
 ...
 */
async function createDatasetAction(req, res) {
    try {
        ...
        const dataset = await (0, datasets_service_1.createDataset)(accountId, isAdmin, body);
        (0, json_1.sendJson)(res, 201, { ok: true, message: "Dataset creado como borrador", data: dataset });
    }
    catch (error) {
 ...
 * @throws {Ninguna}
 */
async function getDatasetByIdAction(req, res) {
    try {
        const id = Number(req.params?.id);
        if (!id || isNaN(id))
            return (0, json_1.sendJson)(res, 400, { ok: false, message: "ID inválido" });
        const dataset = await (0, datasets_service_1.getDatasetById)(id);
        (0, json_1.sendJson)(res, 200, { ok: true, data: dataset });
    }
    catch (error) {
        (0, json_1.sendJson)(res, (0, auth_routes_1.getErrorStatus)(error), { ok: false, message: (0, auth_routes_1.getErrorMessage)(error) });
    }
 ...
 * @throws {Ninguna}
 */
async function deleteDatasetAction(req, res) {
    try {
        const id = Number(req.params?.id);
        if (!id || isNaN(id))
            return (0, json_1.sendJson)(res, 400, { ok: false, message: "ID inválido" });
        const payload = (0, auth_1.tryGetAuthPayload)(req);
        const accountId = Number(payload?.sub);
        const result = await (0, datasets_service_1.removeDataset)(id, accountId);
 ...
 * @throws {Ninguna}
 */
async function updateDatasetAction(req, res) {
    try {
        const id = Number(req.params?.id);
        if (!id || isNaN(id))
            return (0, json_1.sendJson)(res, 400, { ok: false, message: "ID inválido" });
        ...
        const accountId = Number(payload?.sub);
        const body = await (0, body_1.readJsonBody)(req);
        const result = await (0, datasets_service_1.editDataset)(id, accountId, body);
        (0, json_1.sendJson)(res, 200, { ok: true, message: "Dataset actualizado", data: result });
    }
    catch (error) {
        (0, json_1.sendJson)(res, (0, auth_routes_1.getErrorStatus)(error), { ok: false, message: (0, auth_routes_1.getErrorMessage)(error) });
    }
...
async function getPublicDatasetsAction(req, res) {
    try {
        const url = new URL(req.url || "", `http://${req.headers?.host || "localhost"}`);
        const search = url.searchParams.get("search") || "";
        const page = Math.max(1, parseInt(url.searchParams.get("page") || "1", 10));
        ...
        const result = await (0, datasets_service_1.getDatasets)(0, false, search, page, limit, filters);
        // Respondemos con el mismo formato que espera tu frontend
        (0, json_1.sendJson)(res, 200, { ok: true, ...result });
    }
    catch (error) {
        console.error("❌ Error en getPublicDatasetsAction:", error);
        (0, json_1.sendJson)(res, 500, { ok: false, message: "Error interno del servidor" });
    }
}
// 5. Acción para ver detalles de un dataset públicamente (Sin autenticación)
async function getPublicDatasetByIdAction(req, res) {
    try {
        // Tu router personalizado inyecta los parámetros en req.params
        const id = Number(req.params?.id);
        if (!id || isNaN(id)) {
            return (0, json_1.sendJson)(res, 400, { ok: false, message: "ID de dataset inválido" });
        }
 ...
 */
async function requestDatasetAction(req, res) {
    try {
        const payload = (0, auth_1.tryGetAuthPayload)(req);
        const accountId = Number(payload?.sub);
        const body = await (0, body_1.readJsonBody)(req);
        // Llamamos al nuevo servicio
        const dataset = await (0, datasets_service_1.submitDatasetRequest)(accountId, body);
        (0, json_1.sendJson)(res, 201, { ok: true, message: "Dataset enviado exitosamente para validación", data: dataset });
    }
    catch (error) {
 ...
 */
async function validateDatasetAction(req, res) {
    try {
        const id = Number(req.params?.id);
        if (!id || isNaN(id))
            return (0, json_1.sendJson)(res, 400, { ok: false, message: "ID inválido" });
